...
以下案例可直接粘贴到“竞品分析 Agent 工作台”的输入框中。建议先点击“解析需求”，再根据实际需要手动增删竞品和分析维度。

| 场景 | 分析需求示例 | 推荐关注维度 |
| --- | --- | --- |
| AI 编程助手 | 请分析 Cursor、GitHub Copilot、Codex、Claude Code 在 AI 编程助手市场的竞品情况，重点关注产品定位、核心功能、Agent 能力、IDE 集成、价格策略、企业能力、安全合规和适用用户。 | 产品定位、代码生成与编辑能力、Agent 自动化能力、IDE/工作流集成、上下文管理、企业与安全能力、定价策略 |
| AI 数据采集工具 | 请分析 Firecrawl、Jina AI Reader、Apify、Browserbase 在 AI 数据采集和网页结构化抽取领域的竞品情况，重点比较抓取稳定性、结构化输出、反爬处理、API 易用性、开发者生态和价格。 | 抓取能力、结构化抽取质量、反爬与浏览器自动化、API/SDK、数据新鲜度、成本与限额、开发者生态 |
| 企业协作 SaaS | 请分析飞书、钉钉、企业微信、Notion 在企业协作平台场景下的差异，重点关注组织通讯、文档协作、项目管理、审批流程、开放平台、AI 能力和企业采购成本。 | 通讯协作、文档与知识库、项目/任务管理、流程审批、开放平台、AI 助手能力、权限与合规、采购成本 |
| 电商平台选型 | 请分析 Shopify、Shopline、WooCommerce、Magento 面向跨境电商品牌建站的竞品差异，重点关注建站门槛、支付与物流生态、插件市场、SEO、订单管理、多语言多币种和长期运维成本。 | 建站体验、支付物流生态、插件扩展、营销与 SEO、多语言多币种、订单与库存、运维成本、适用商家规模 |
| 本地生活产品 | 请分析美团、大众点评、抖音生活服务、小红书在本地生活到店消费场景下的竞争格局，重点关注流量入口、商家运营工具、内容种草、交易闭环、用户评价体系和佣金模式。 | 流量入口、内容与种草、交易闭环、商家工具、评价体系、广告与佣金、用户心智、城市覆盖 |
| 在线教育平台 | 请分析 Coursera、Udemy、网易云课堂、得到在成人在线学习场景的竞品表现，重点关注课程供给、内容质量、学习路径、证书认可度、社区互动、AI 学习辅助和商业模式。 | 课程供给、内容质量、学习路径、证书/认证、互动与社群、AI 辅助、付费模式、用户留存 |
| 数据分析与 BI | 请分析 Tableau、Power BI、Looker、Apache Superset 在企业 BI 场景下的竞品差异，重点关注数据连接、可视化能力、自助分析、权限治理、嵌入式分析、部署方式和总体拥有成本。 | 数据连接、可视化表达、自助分析、权限治理、嵌入能力、部署与运维、成本、生态集成 |
| 云服务与技术选型 | 请分析 AWS Lambda、Google Cloud Functions、Azure Functions、Cloudflare Workers 在 Serverless 计算场景下的技术选型差异，重点关注冷启动、运行时支持、边缘能力、可观测性、生态集成、成本和供应商锁定风险。 | 性能与冷启动、运行时支持、边缘计算、可观测性、生态集成、计费模型、锁定风险、适用架构 |

也可以按自己的业务场景改写成更具体的问题，例如增加目标用户、所在行业、预算范围、所在地区、上线时间要求或必须比较的竞品。输入越具体，系统生成的竞品列表、分析维度和最终报告会越贴近实际决策。
